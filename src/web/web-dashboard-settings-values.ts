...
export function activeSettingsValues(current: ConnectorConfig, context: ActiveSettingsContext): Record<string, string | undefined> {
  return {
    ...
    NORDRELAY_WEBAUTHN_ENABLED: boolValue(current.webAuthnEnabled),
    NORDRELAY_WEBAUTHN_RP_NAME: current.webAuthnRpName,
    NORDRELAY_WEBAUTHN_RP_ID: current.webAuthnRpId,
    NORDRELAY_WEBAUTHN_ORIGIN: current.webAuthnOrigin,
