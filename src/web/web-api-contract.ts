...
export const WEB_API_ROUTE_DEFINITIONS = [
  ...
  exact("/api/plugins/analyze", ["POST"], "plugins.install"),
  ...
  dynamic("/api/plugins/:id/enable", "^/api/plugins/[^/]+/enable$", ["POST"], "plugins.enable", `/api/plugins/${stringToken}/enable`),
  dynamic("/api/plugins/:id/disable", "^/api/plugins/[^/]+/disable$", ["POST"], "plugins.enable", `/api/plugins/${stringToken}/disable`),
  dynamic("/api/plugins/:id/settings", "^/api/plugins/[^/]+/settings$", ["PATCH"], "plugins.settings.write", `/api/plugins/${stringToken}/settings`),
  dynamic("/api/plugins/:id/log", "^/api/plugins/[^/]+/log$", ["GET"], "plugins.read", `/api/plugins/${stringToken}/log`),
  dynamic("/api/plugins/:id/events", "^/api/plugins/[^/]+/events$", ["GET"], "plugins.read", `/api/plugins/${stringToken}/events`),
  dynamic("/api/plugins/:id/manifest", "^/api/plugins/[^/]+/manifest$", ["POST"], "plugins.install", `/api/plugins/${stringToken}/manifest`),
  dynamic("/api/plugins/:id/update-check", "^/api/plugins/[^/]+/update-check$", ["GET"], "plugins.install", `/api/plugins/${stringToken}/update-check`),
  dynamic("/api/plugins/:id/update", "^/api/plugins/[^/]+/update$", ["POST"], "plugins.install", `/api/plugins/${stringToken}/update`),
  dynamic("/api/plugins/:id/jobs", "^/api/plugins/[^/]+/jobs$", ["GET", "POST"], readWrite("plugins.read", "plugins.install"), `/api/plugins/${stringToken}/jobs`),
  dynamic("/api/plugins/:id/jobs/:jobId", "^/api/plugins/[^/]+/jobs/[^/]+$", ["GET"], "plugins.read", `/api/plugins/${stringToken}/jobs/${stringToken}`),
  dynamic("/api/plugins/:id/jobs/:jobId/cancel", "^/api/plugins/[^/]+/jobs/[^/]+/cancel$", ["POST"], "plugins.install", `/api/plugins/${stringToken}/jobs/${stringToken}/cancel`),
  dynamic("/api/plugins/:id/rollback", "^/api/plugins/[^/]+/rollback$", ["POST"], "plugins.install", `/api/plugins/${stringToken}/rollback`),
  dynamic("/api/plugins/:id/invoke", "^/api/plugins/[^/]+/invoke$", ["POST"], "workflows.run", `/api/plugins/${stringToken}/invoke`),
  dynamic("/api/plugins/:id/command", "^/api/plugins/[^/]+/command$", ["POST"], "workflows.run", `/api/plugins/${stringToken}/command`),
  dynamic("/api/plugins/:id/aggregate-command", "^/api/plugins/[^/]+/aggregate-command$", ["POST"], "plugins.read", `/api/plugins/${stringToken}/aggregate-command`),
  ...
  exact("/api/projects", ["GET", "POST"], readWrite("projects.read", "projects.write")),
  dynamic("/api/projects/jobs/:id/cancel", "^/api/projects/jobs/[^/]+/cancel$", ["POST"], "projects.run", `/api/projects/jobs/${stringToken}/cancel`),
  dynamic("/api/projects/:id", "^/api/projects/[^/]+$", ["GET", "PATCH", "DELETE"], readWrite("projects.read", "projects.write"), `/api/projects/${stringToken}`),
  dynamic("/api/projects/:id/sessions", "^/api/projects/[^/]+/sessions$", ["POST"], "projects.write", `/api/projects/${stringToken}/sessions`),
  dynamic("/api/projects/:id/sessions/:linkId", "^/api/projects/[^/]+/sessions/[^/]+$", ["DELETE"], "projects.write", `/api/projects/${stringToken}/sessions/${stringToken}`),
  dynamic("/api/projects/:id/summary", "^/api/projects/[^/]+/summary$", ["PATCH"], "projects.write", `/api/projects/${stringToken}/summary`),
  dynamic("/api/projects/:id/summary/run", "^/api/projects/[^/]+/summary/run$", ["POST"], "projects.run", `/api/projects/${stringToken}/summary/run`),
  dynamic("/api/projects/:id/summary/history", "^/api/projects/[^/]+/summary/history$", ["GET"], "projects.read", `/api/projects/${stringToken}/summary/history`),
  dynamic("/api/projects/:id/summary/history/:revisionId", "^/api/projects/[^/]+/summary/history/[^/]+$", ["GET", "PATCH", "DELETE"], readWrite("projects.read", "projects.write"), `/api/projects/${stringToken}/summary/history/${stringToken}`),
  dynamic("/api/projects/:id/summary/history/:revisionId/restore", "^/api/projects/[^/]+/summary/history/[^/]+/restore$", ["POST"], "projects.write", `/api/projects/${stringToken}/summary/history/${stringToken}/restore`),
  dynamic("/api/projects/:id/plan", "^/api/projects/[^/]+/plan$", ["PATCH"], "projects.write", `/api/projects/${stringToken}/plan`),
  dynamic("/api/projects/:id/plan/run", "^/api/projects/[^/]+/plan/run$", ["POST"], "projects.run", `/api/projects/${stringToken}/plan/run`),
  dynamic("/api/projects/:id/plan/history", "^/api/projects/[^/]+/plan/history$", ["GET"], "projects.read", `/api/projects/${stringToken}/plan/history`),
  dynamic("/api/projects/:id/plan/history/:revisionId", "^/api/projects/[^/]+/plan/history/[^/]+$", ["GET", "PATCH", "DELETE"], readWrite("projects.read", "projects.write"), `/api/projects/${stringToken}/plan/history/${stringToken}`),
  dynamic("/api/projects/:id/plan/history/:revisionId/restore", "^/api/projects/[^/]+/plan/history/[^/]+/restore$", ["POST"], "projects.write", `/api/projects/${stringToken}/plan/history/${stringToken}/restore`),
  dynamic("/api/projects/:id/jobs", "^/api/projects/[^/]+/jobs$", ["GET"], "projects.read", `/api/projects/${stringToken}/jobs`),
