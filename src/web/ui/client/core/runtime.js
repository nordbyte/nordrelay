const state = { snapshot:null, controls:null, newSessionControls:null, enabledAgents:[], auth:null, profile:null, csrfToken:null, permissions:[], settings:[], currentPage:'overview', settingsGroup:null, settingsWizard:null, accessTab:'users', adapterTab:'adapters', peerTab:'status', workflowTab:'templates', queueTab:'queue', queuePlanner:null, workflowTemplates:[], workflows:[], workflowRuns:[], logsPlain:'', logTimer:null, toastTimer:null, stickyToastActive:false, stickyToastText:'', cliStatusActive:false, webMirror:null, selectedArtifactTurns:new Set(), mediaRecorder:null, recordedChunks:[], events:null, reconnectTimer:null, notifications:false, toolTooltipTimer:null, toolTooltipTarget:null, toolsVisible:false, themePreference:null, agentUpdateJobs:[], sessionsRequestId:0, chatHistoryRequestId:0, chatRenderVersion:0, activeSessions:null, peers:null, peerInviteSecrets:{}, peerProbeResult:null, peerDiscoveryJobs:[], selectedPeer:localStorage.getItem('nordrelayPeerTarget')||'local' };
globalThis.NORDRELAY_WEBUI_RUNTIME_STATE=state;
const PAGE_LABELS={overview:'Overview',chat:'Chat',workflows:'Workflows',sessions:'Sessions',queue:'Queue',tasks:'Tasks',metrics:'Metrics',activity:'Activity',trace:'Trace',artifacts:'Artifacts',adapters:'Adapters',peers:'Peers',access:'Users',version:'Version',settings:'Settings',logs:'Logs',diagnostics:'Diagnostics'};
