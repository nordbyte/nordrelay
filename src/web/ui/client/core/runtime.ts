...
function applyPermissions(){
  ...
  const disableMap=[
    ...
    ['#createProjectBtn,#saveProjectSummaryBtn,#saveProjectPlanBtn,#linkProjectCurrentSessionBtn,#linkProjectSessionBtn,[data-project-edit],[data-project-delete],[data-project-select],[data-project-session-unlink]','projects.write'],
    ['#runProjectSummaryBtn,#runProjectPlanBtn,[data-project-job-cancel]','projects.run'],
