...
function sessionDetailStub(
  ...
  return runtime.sessionStubForMetadata({
    ...
    activeLaunchProfileId: active.launchProfileId,
    launchProfileLabel: active.launchProfileLabel,
    launchProfileBehavior: active.launchProfileBehavior,
    sandboxMode: active.sandboxMode,
    approvalPolicy: active.approvalPolicy,
    approvalsReviewer: active.approvalsReviewer,
    nextLaunchProfileLabel: active.nextLaunchProfileLabel,
    nextLaunchProfileBehavior: active.nextLaunchProfileBehavior,
    nextApprovalsReviewer: active.nextApprovalsReviewer,
    nextUnsafeLaunch: active.nextUnsafeLaunch,
    sessionPath: record?.sessionPath ?? active.sessionPath,
