...
import { clearLogFile, getAgentUpdateLogPath, getConnectorHealth, getConnectorLogPath, getUpdateLogPath, getVersionChecks, readConnectorState, readFormattedLogTail, spawnConnectorRestart, spawnSelfUpdate, type FormattedLogReadOptions, type FormattedLogTail } from "../support/operations.js";
...
import { createRuntimePluginService } from "./relay-plugin-service.js";
...
import { initialRelayEventSeq, relayRuntimePrepareEvent, relayRuntimeReplayEvents } from "./relay-runtime-events.js";
import {
  relayRuntimeLocks,
...
export class RelayRuntime {
  ...
  eventSeq = initialRelayEventSeq(); eventHistory: RelayEvent[] = [];
