...
const LOCAL_ONLY_ROUTE_PATHS = new Set([
  ...
  "/api/plugins/:id/aggregate-command",
  "/api/peers",
  "/api/peers/invite",
  "/api/peers/pair",
  "/api/peers/probe",
  ...
  "/api/audit",
  "/api/projects",
  "/api/projects/jobs/:id/cancel",
  "/api/projects/:id",
  "/api/projects/:id/sessions",
  "/api/projects/:id/sessions/:linkId",
  "/api/projects/:id/summary",
  "/api/projects/:id/summary/history",
  "/api/projects/:id/summary/history/:revisionId",
  "/api/projects/:id/summary/history/:revisionId/restore",
  "/api/projects/:id/summary/run",
  "/api/projects/:id/plan",
  "/api/projects/:id/plan/history",
  "/api/projects/:id/plan/history/:revisionId",
  "/api/projects/:id/plan/history/:revisionId/restore",
  "/api/projects/:id/plan/run",
