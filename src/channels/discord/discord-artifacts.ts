...
export interface DiscordArtifactRequest {
  contextKey: ChannelContextKey;
  context: ChannelContext;
}

export interface DiscordArtifactCommandDeps<TRequest extends DiscordArtifactRequest> {
...
export function createDiscordArtifactCommandHandler<TRequest extends DiscordArtifactRequest>(
  deps: DiscordArtifactCommandDeps<TRequest>,
...
export async function sendRecentDiscordArtifacts<TRequest extends DiscordArtifactRequest>(
  deps: DiscordArtifactCommandDeps<TRequest>,
  request: TRequest,
...
function renderDiscordArtifactReports(contextKey: ChannelContextKey, reports: ArtifactTurnReport[]) {
...
async function deliverDiscordArtifactZip<TRequest extends DiscordArtifactRequest>(
  deps: DiscordArtifactCommandDeps<TRequest>,
  request: TRequest,
...
async function deliverDiscordArtifactReport<TRequest extends DiscordArtifactRequest>(
  deps: DiscordArtifactCommandDeps<TRequest>,
  request: TRequest,
  report: ArtifactTurnReport,
): Promise<void> {
...
async function sendDiscordArtifactFile<TRequest extends DiscordArtifactRequest>(
  deps: DiscordArtifactCommandDeps<TRequest>,
  request: TRequest,
  artifact: Artifact,
): Promise<boolean> {
