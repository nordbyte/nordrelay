...
import type { AgentExternalActivity, AgentSessionInfo, AgentSessionService } from "../../agents/shared/agent.js";
import { getAgentActivityLog } from "../../agents/shared/agent-activity.js";
import type { AuditEvent, AuditLogStore } from "../../access/audit-log.js";
import {
  capabilitiesOf,
...
import { canWriteWithLock, type SessionLockOwner, type SessionLockStore } from "../../access/session-locks.js";
