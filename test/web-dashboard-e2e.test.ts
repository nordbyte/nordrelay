...
describe("web dashboard browser-flow assets", () => {
  ...
  it("includes plugin management in the local administration WebUI", () => {
    ...
    expect(pageSource).not.toContain('data-plugin-tab="install"');
    expect(pageSource).toContain('id="pluginMarketplace"');
    expect(pageSource).toContain('id="openInstallPluginDialogBtn"');
    ...
    expect(js).toContain("function openPluginInstallDialog");
    expect(js).toContain("pluginInstallSource");
  ...
  it("wraps plugin web panels with the shared NordRelay panel UI bridge", () => {
    ...
    expect(js).toContain("function pluginPanelInlineHtml");
    expect(js).toContain("function bindPluginPanelSurface");
    expect(js).toContain("function cleanupPluginPanelSurfaces");
    expect(js).toContain("function pluginPanelRegistry");
    expect(js).toContain("function executePluginPanelCode");
    expect(js).toContain("function executePluginPanelScriptAtPlaceholder");
    ...
    expect(js).toContain("cleanupPluginPanelSurfaces(resultEl)");
    expect(js).not.toContain('sandbox="allow-scripts"');
    expect(js).not.toContain("data-plugin-panel-frame");
    expect(js).not.toContain("data-plugin-panel-url");
    expect(pluginPanelSource).not.toContain("URL.createObjectURL");
    expect(pluginPanelSource).not.toContain("URL.revokeObjectURL");
    ...
    expect(css).toContain(".plugin-panel-surface .metrics-grid+.metrics-chart-stack");
    expect(css).toContain(".plugin-panel-surface .progress-svg");
    expect(css).toContain(".plugin-panel-surface .chart-tooltip[hidden]");
