...
describe("bot-ui", () => {
  describe("renderHelpMessage", () => {
    it("contains all command groups", () => {
      ...
      expect(plain).toContain("/mirror");
      expect(plain).toContain("/notify");
  ...
  describe("renderWelcomeFirstTime", () => {
    it("shows welcome without auth warning", () => {
      ...
      expect(html).toContain("NordRelay is ready");
      expect(plain).toContain("/help");
  ...
  describe("renderWelcomeReturning", () => {
    it("shows session info for returning user", () => {
      ...
      expect(html).toContain("NordRelay");
  ...
  describe("formatSessionLabel", () => {
    ...
    it("shows star for pinned inactive session", () => {
      const label = formatSessionLabel({
        workspace: "/project",
        title: "test",
        relativeTime: "now",
